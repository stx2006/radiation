...
## 项目特色
- **动态仿真**：支持对辐射源和测向站的动态仿真，实时计算和显示辐射源位置。
- **多种调制方式**：支持多种辐射源调制方式，包括调频（FM）和调幅（AM）。
- **可视化**：提供详细的可视化功能，动态显示辐射源的真实位置和计算位置，并保留路径。
- **用户界面**：提供友好的用户界面，便于用户配置和控制仿真。
- **多电脑支持**：支持多电脑协同仿真，分别模拟辐射源和测向站。
